...
CFLAGS = -D_GNU_SOURCE
SLR_LIB ?=/home/hexin/Downloads/sihle
...
ifeq ($(DEBUG),1)
  ...
  DEBUG_FLAGS=-Wall
  CFLAGS += -O3 -DADD_PADDING -DNODEBUG
endif
...
# default setings   -lslr_ttas
PLATFORM=-DDEFAULT -DRTM -DNUMA 
GCC=gcc-4.8
PLATFORM_NUMA=0
OPTIMIZE=
LIBS += -lrt -lpthread -lm -lclht -lssmem -lsspfd -mrtm -llock 
...
MAIN_BMARK := $(BMARKS)/test.c  # memory allocation
